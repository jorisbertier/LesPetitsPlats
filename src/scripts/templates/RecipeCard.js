class RecipeCard {
    ...
    createTemplate() {
        ...
        max-400:w-80 max-426:w-96 max-500:w-96
        max-350:w-64 max-500:justify-center max-500:h-auto max-500:pb-4 `;
        card.innerHTML = `
        <a href="#">
                    <div class="relative">
                        <img class="w-full rounded-t-3xl h-64 object-cover max-lg:h-52 max-350:h-36 max-375:h-40 max-500:h-44" src="/src/img/recipes/${image}">
                    ...
                    <div class="p-6 mt-3 max-sm:mt-0">
                        ...
                        <h4 class="text-secondary-color font-anton uppercase text-xs mb-2 font-thin tracking-widest max-400:hidden mt-5 max-500:text-xs">Recette</h4>
                    <p class="text-sm font-manrope max-400:hidden max-500:text-xs">${formatedDescription}.</p>
